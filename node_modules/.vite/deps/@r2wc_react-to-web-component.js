...
var x = (t, e, r) => e in t ? j(t, e, { enumerable: true, configurable: true, writable: true, value: r }) : t[e] = r;
...
var A = Symbol.for("r2wc.render");
var h = Symbol.for("r2wc.connected");
var p = Symbol.for("r2wc.context");
var i = Symbol.for("r2wc.props");
function z(t, e, r) {
  var $, k, O;
  e.props || (e.props = t.propTypes ? Object.keys(t.propTypes) : []);
  const d = (Array.isArray(e.props) ? e.props.slice() : Object.keys(e.props)).filter((s2) => s2 !== "container"), f2 = {}, g = {}, m = {};
  for (const s2 of d) {
    f2[s2] = Array.isArray(e.props) ? "string" : e.props[s2];
    const u = J(s2);
    g[s2] = u, m[u] = s2;
  }
  class S extends HTMLElement {
    constructor() {
      ...
      for (const c2 of d) {
        const l = g[c2], n = this.getAttribute(l), o2 = f2[c2], a2 = w[o2];
        n && (a2 != null && a2.parse) && (this[i][c2] = a2.parse(n, this));
      }
    }
    ...
    disconnectedCallback() {
      this[h] = false, this[p] && r.unmount(this[p]), delete this[p];
    }
    attributeChangedCallback(c2, l, n) {
      const o2 = m[c2], a2 = f2[o2], y = w[a2];
      o2 in f2 && (y != null && y.parse) && (this[i][o2] = y.parse(n, this), this[A]());
    }
    [($ = h, k = p, O = i, A)]() {
  ...
  for (const s2 of d) {
    const u = g[s2], c2 = f2[s2];
    Object.defineProperty(S.prototype, s2, {
      enumerable: true,
      configurable: true,
      get() {
        return this[i][s2];
      ...
      set(l) {
        ...
        if (n != null && n.stringify) {
          const o2 = n.stringify(l);
          this.getAttribute(u) !== o2 && this.setAttribute(u, o2);
        }
      }
    });
  }
...
function i2({ root: t, ReactComponent: e }, r) {
...
function s(t, e = {}) {
  return z(t, e, { mount: f, update: i2, unmount: a });
}
export {
  s as default
};
